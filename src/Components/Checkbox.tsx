...
const Checkbox: React.FC<CheckboxProps> = ({ label, isChecked, onChange }) => {
    const handleChange = () => {
        onChange(!isChecked); // Notifique o pai com o novo estado
    };
        ...
        <label className="flex items-center cursor-pointer">
            <div className="relative">
                ...
                <div className="checkbox-container w-6 h-6 border border-grey-purs rounded-md bg-white flex justify-center items-center mr-2">
                    {isChecked && <svg className="fill-current w-4 h-4 text-blue-purs pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>}
                </div>
            </div>
