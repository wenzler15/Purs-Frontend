...
const AddUpdateDepartment: React.FC = () => {
    ...
    const handleSave = async () => {
        try {
            ...
            await api.post('/departments', toSend, {
                headers: {
                    Authorization: token,
                },
            });
            ...
            <div className="w-full">
                ...
                <div className="w-full bg-gradient-to-b from-[#8B95CE] to-[#DBF4FA] h-full overflow-y-auto pt-10 pl-4 pr-4 box-border pb-5">
                    <div className="w-full bg-[#fff] p-5 rounded-lg">
                        ...
                        <div className="w-[45%]">
                            <Dropdown text="Selecione um responsável" options={employess} onSelect={handleSelect} />
                        </div>
                        ...
                        <div className="w-full mt-5">
                            ...
                            {responsibilities.map((item, index) => (
                                <div>
                                    <TextInput value={item.value} text={`Responsabilidade ${index + 1}`} onChange={(e) => handleChangeResp(e.target.value, index)} />
