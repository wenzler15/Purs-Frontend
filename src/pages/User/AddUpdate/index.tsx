                ...
                <div className="w-full bg-gradient-to-b from-[#8B95CE] to-[#DBF4FA] h-full pt-10 box-border px-4 pb-5 overflow-y-auto">
                    <div className="w-full rounded-lg bg-[#fff] p-5 px-8">
                        ...
                        <div className="flex w-full justify-between mt-5">
                            <div className="w-[50%]">
                                <div className="w-[90%]">
                                    <Dropdown text="Selecione um cargo" options={roles} onSelect={handleSelectRole} />
                                </div>
                            </div>

                            <div className="w-[50%]">
                                <div className="w-[90%]">
                                    <Dropdown text="Selecione um líder" options={employees} onSelect={handleSelectLeader} />
                                </div>
                            </div>
                        </div>
