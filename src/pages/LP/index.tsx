    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full pt-10 bg-[#5B359E] flex justify-between flex-wrap'>
                <div className='relative sm:w-[50%] sm:min-w-[310px] flex justify-center'>
                    <img src={Woman} className='absolute top-[12%] z-10 w-[65%] sm:w-[60%] sm:max-w-[400px]' />
                    <img src={RectangleComplete} className='relative w-[90%] h-[500px] sm:max-w-[400px]' />
                </div>
            ...
            <div className='w-full pt-10 bg-[#5B359E] flex justify-between pb-10 flex-wrap-reverse'>
                ...
                <div className='relative w-[50%] min-w-[310]'>
